...
contract DeployAll is Script {
    function run() external returns (FreelancerContract, StakingRewards, MyToken, NDASoulBoundToken, FreelancerSoulBoundToken) {
        vm.startBroadcast();
        ...
        // 3. Deploy the NDASoulBoundToken contract.
        NDASoulBoundToken ndaToken = new NDASoulBoundToken();

        // 4. Deploy the FreelancerSoulBoundToken contract.
        FreelancerSoulBoundToken freelancerToken = new FreelancerSoulBoundToken();
        ...
        vm.stopBroadcast();
        return (freelancerContract, stakingContract, token, ndaToken, freelancerToken   );
    }
}